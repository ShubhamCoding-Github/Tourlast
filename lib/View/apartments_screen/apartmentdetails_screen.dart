import 'package:Tourlast/View/apartments_screen/apartment_booking_review.dart';
                ...
                Container(
                  decoration: const BoxDecoration(
                      ...
                      image: DecorationImage(
                          image:
                              AssetImage("assets/images/Mask Group 26@3x.png"),
                          fit: BoxFit.cover)),
                  height: 85.sp,
                  child: Padding(
                    padding:
            ...
            child: Column(
              ...
              children: [
                ...
                addTextPoppinsLight(
                    height: 2,
                    text:
                        'The karma villa in a hotel a modern concept located in the Badung area, It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.',
                    textColor: const Color(0xff919191),
                    fontSize: 13.0),
                buildSizeHeight(2),
                addTextPoppinsMedium(
