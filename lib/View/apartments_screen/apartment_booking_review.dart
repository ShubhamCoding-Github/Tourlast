...
class ApartmentBookingReview extends StatefulWidget {
  const ApartmentBookingReview({super.key});

  @override
  State<ApartmentBookingReview> createState() => _ApartmentBookingReviewState();
}

class _ApartmentBookingReviewState extends State<ApartmentBookingReview> {
  int _value = 1;
  @override
