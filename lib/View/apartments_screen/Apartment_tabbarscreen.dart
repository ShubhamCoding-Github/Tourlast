...
class ApartmentTabBarScreen extends StatefulWidget {
  const ApartmentTabBarScreen({super.key});

  @override
  State<ApartmentTabBarScreen> createState() => _ApartmentTabBarScreenState();
}

class _ApartmentTabBarScreenState extends State<ApartmentTabBarScreen> {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          buildSizeHeight(2),
          Image.asset('assets/images/Group 397@3x.png'),
          buildSizeHeight(2),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              addTextPoppinsMedium(
                  text: 'Popular Apartments',
