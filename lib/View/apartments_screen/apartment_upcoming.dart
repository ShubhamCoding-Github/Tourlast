...
import 'apartment_bookingdetails.dart';

class ApartmentUpcoming extends StatelessWidget {
  const ApartmentUpcoming({super.key});
            ...
            itemBuilder: (BuildContext context, int index) {
              return Column(
                children: [
                  InkWell(
                    onTap: () {
                      Get.to(const ApartmentBookingDetails());
                    },
                    child: Container(
