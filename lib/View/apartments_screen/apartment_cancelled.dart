import 'package:Tourlast/View/apartments_screen/apartment_booking_cancelled.dart';
...
class ApartmentCancelled extends StatelessWidget {
  const ApartmentCancelled({super.key});
              ...
              itemBuilder: (BuildContext context, int index) {
                return Column(
                  children: [
                    InkWell(
                      onTap: () {
                        Get.to(const ApartmentCancelledBooking());
                      },
                      child: Container(
