...
class ApartmentBookingDetails extends StatelessWidget {
  const ApartmentBookingDetails({super.key});
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  Image.asset('assets/images/Mask Group 46@3x.png',height:21.sp,),
                  Container(
                    decoration:  const BoxDecoration(
                      color: Colors.white,
