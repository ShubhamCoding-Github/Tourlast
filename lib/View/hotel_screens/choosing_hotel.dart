import 'package:Tourlast/View/hotel_screens/hotel_details_screen.dart';
...
class ChoosingHotel extends StatefulWidget {
  const ChoosingHotel({super.key});

  @override
  State<ChoosingHotel> createState() => _ChoosingHotelState();
}

class _ChoosingHotelState extends State<ChoosingHotel> {
