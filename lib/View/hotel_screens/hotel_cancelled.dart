import 'package:Tourlast/View/hotel_screens/bookingdetails_cancelled.dart';
...
class HotelCancelled extends StatelessWidget {
  const HotelCancelled({super.key});
          ...
          itemBuilder: (BuildContext context, int index) {
            return Column(
              children: [
                InkWell(
                  onTap: () {
                    Get.to(const BookingDetailsCancelled());
                  },
                  child: Container(
