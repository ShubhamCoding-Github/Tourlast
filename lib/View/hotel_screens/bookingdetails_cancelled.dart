...
class BookingDetailsCancelled extends StatelessWidget {
  const BookingDetailsCancelled({super.key});
            ...
            Positioned(
              ...
              child:Column(
                children: [
                  ...
                  Image.asset('assets/images/Mask Group 46@3x.png',height:20.50.sp,),
                  Container(
                    width: 85.w,
                    decoration: const BoxDecoration(
                      color: Colors.white,
