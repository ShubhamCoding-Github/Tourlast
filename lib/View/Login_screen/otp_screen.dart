...
class OtpScreen extends StatefulWidget {
  final  String mobile_no;
   OtpScreen({super.key,required this.mobile_no});
            ...
            child: Column(
              ...
              children: [
                ...
                Text.rich(
                  ...
                  TextSpan(
                    children: [
                      TextSpan(
                          style: openPoppinsLightTextStyle().copyWith(),
                          text: 'We send the OTP code via phone number to '),
                       TextSpan(
                ...
                PinCodeTextField(
                  ...
                  autoFocus: true,
                  obscureText: false,
                  autovalidateMode: _pinPutController.text.length == 4
                ...
                CustomButton(
                 ...
                 onPressed: () {
                   Get.to(
                     controller.checkOtp(_pinPutController.text,false,widget.mobile_no),
                     // const ForgotPasswordScreen(),
                   );
                 //   if (_pinPutController.text.length == 4) {
                 //     Get.find<AuthController>().checkOtp(
                 //         _pinPutController.text, widget.phone, widget.pageName);
                 //   } else {
                 // showSnackBar(
                 //         message: "Enter 4 Digit OTP", title: "Error");
                 //   }
                 },
                ),
                buildSizeHeight(2),
